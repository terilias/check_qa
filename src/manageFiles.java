 ...
 * @author Ηλίας Τερζής
 * @version 1.0
 * @date Ιανουάριος 2020 Αυτή η κλάση είναι υπεύθυνη για το άνοιγμα των αρχείων εισόδου: το αρχείο
...
public class manageFiles {
    ...
    /**
     * Μέθοδος για την εξαγωγή των αποτελεσμάτων ελέγχου-η οποία γίνεται στην κλάση Controller- σε
     * αρχείο κειμένου. Για κάθε αντικείμενο μαθήματος το οποίο δεν περιέχει έστω και ένα από τα
     * πεδία προς έλεγχο στην σελίδα περιγραφής του, εμφανίζονται τα πεδία που παρουσιάζει έλλειψη.
     *
    ...
    public void writeToFile(String fieldsFileName) {
        try {
            ...
            fields = getDescriptionFields(
                fieldsFileName);//ο πίνακας με τα πεδία για τα οποία γίνεται ο έλεγχος
            ...
            BufferedWriter bw = new BufferedWriter(
                new FileWriter("result.txt"));//ο συγγραφέας του αρχείου εξόδου
            ...
            for (int j = 0; j < crs.size(); j++) {
                ...
                exist = ctrl.check(fields, crs.get(
                    j));//ο πίνακας με τα αποτελέσματα ελέγχου ύπαρξης των πεδίων στην περιγραφή του μαθήματος γεμίζει.Ο έλεγχος γίνεται στην κλάση Controller
                if (ctrl.hasEmptyField(exist)) {
                    ...
                    bw.write(
                        System.lineSeparator());//η επόμενη εκτύπωση θα γίνει στην επόμενη γραμμή
                }
    ...
    /**
     * Μέθοδος που καλεί την κατάλληλη μέθοδο της κλάσης XMLParserSAX για την ανάγνωση του xml από
     * το οποίο αντλεί τα δεδομένα των μαθημάτων.
     *
    ...
    public List<Course> readXML() {
        ...
        return parser.getCourses(
            xml);//μέσα από την κλάση XMLParser στην οποία στέλνεται το  μονοπάτι προς το αρχείο xml παίρνουμε τα μαθήματα
    }
    ...
    /**
     * Η μέθοδος αυτή διαβάζει το αρχείο κειμένου που περιέχει τα πεδία της περιγραφής του
     * μαθήματος, για τα οποία θέλουμε να γίνει έλεγχος (αν υπάρχουν ή όχι στην περιγραφή του
     * μαθήματος).
     *
