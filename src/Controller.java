 ...
 * Σε αυτή την κλάση γίνεται ο έλεγχος για την πληρότητα των πληροφοριών στην σελίδα περιγραφής του μαθήματος.
 */
public class Controller {
    ...
    /**
     * Η μέθοδος ελέγχου έλλειψης περιεχομένου στις περιγραφές των μαθημάτων.
     * Για το μάθημα ελέγχεται εάν το κάθε πεδίο υπάρχει μέσα στην περιγραφή του.Ανάλογα με το αν υπάρχει ή όχι, γεμίζει έναν boolean πίνακα
     * που είναι παράλληλος με τον πίνακα των πεδίων και περιέχει το αποτέλεσμα του ελέγχου για αυτό το πεδίο .Αυτός ο πίνακας είναι που επιστρέφεται.
     * @param fields ο έλεγχος θα γίνει για το αν υπάρχουν τα πεδία fields στην περιγραφή του μαθήματος
