 ...
 * και των πακέτων διαχείρισης xml της java παίρνει τα δεδομένα από αυτό.Προτιμήθηκε ο SAX parser έναντι του DOM καθώς έπειτα από 
 * σχετική έρευνα διαπιστώθηκε ότι είναι πιο  αποδοτικός τρόπος ως προς τη διαχείριση μνήμης.
 */
