 ...
 * @author Ηλίας Τερζής
 * @version 1.0
 * @date Ιανουάριος 2020 Αυτή η κλάση είναι τυποποιημένη υλοποίηση του Handler για το SAX parsing.
 * Για αυτό τον λόγο και υπάρχει έλλειψη τεκμηρίωσης. Για μια αναλυτική περιγραφή με τον κώδικα και
 * παραδείγματα, ανατρέξτε στον ακόλουθο σύνδεσμο: https://www.journaldev.com/1198/java-sax-parser-example
 */
