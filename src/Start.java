...
public class Start {
    ...
    /**
     * Η main μέθοδος του project δέχεται ως είσοδο από το τερματικό τα απαρίτητα ορίσματα:
     *  * 1)το όνομα του αρχείου xml και
     *  * 2)το όνομα του αρχείου με τα πεδία που θα ελεγχθούν.
